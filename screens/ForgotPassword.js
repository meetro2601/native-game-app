import { SafeAreaView, ScrollView, View, Text, TouchableOpacity, ImageBackground, ActivityIndicator } from "react-native";
    ...
    return (
        <View style={[loginStyles.form, { marginTop: 20 }]}>
            ...
            <View style={[loginStyles.formLabel, loginStyles.formLabelIcon]}>
                ...
                <TextInput style={[loginStyles.formInput]} value={email} 
            ...
            <TouchableOpacity onPress={handleLogin} style={[loginStyles.font20, loginStyles.button, loginStyles.buttonPrimary]} accessibilityRole="button">
